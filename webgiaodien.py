...
# Render lưu Secret Files trong thư mục này:
SECRETS_DIR = os.environ.get("RENDER_SECRETS_DIR", "/opt/render/project/.render")
CRED_PATH = os.path.join(SECRETS_DIR, "firebase-key.json")  # tên bạn đã lưu trong Secret Files
